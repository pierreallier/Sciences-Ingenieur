...
\begin{itemize}
 ...
 \item de la procédure d'utilisation de Simscape disponible à la page \pageref{procedure_matlab},
\end{itemize}}
...
\begin{center}
\def\svgwidth{\columnwidth}
\input{"../../Systemes/\systemes/\schemacinematique.pdf_tex"}
\end{center}

\questioncomp{mod}{Déterminer \anglesortie\ en fonction de \angleentree\ et des dimensions géométriques du système en utilisant la loi de fermeture géométrique. Les dimensions seront mesurées sur le système.}

\questioncomp{res}{Compléter le modèle Simscape avec ces équation comme sur la procédure \pageref{procedure_matlab} et vérifier que les résultats correspondent.}

\questioncomp{res}{A l'aide d'un script python, faire varier \angleentree\ de \deltaangleentree. Et tracer \anglesortie.}

\questioncomp{exp}{Proposer un protocole permettant de mesurer les valeurs extrêmes (qui correspondent à la variation de \angleentree\ de \deltaangleentree) de \anglesortie.}
...
On aura ainsi:
\begin{itemize}
 \item \omegaentreecomplet,
 \item \omegasortiecomplet.
\end{itemize}

\questioncomp{mod}{Déterminer \omegasortie\ en fonction de \omegaentree\ et des paramètres géométriques du système, en utilisant la loi de fermeture cinématique. Les dimensions seront mesurées sur le système afin d'effectuer l'application numérique.}

\questioncomp{res}{Compléter le modèle Simscape avec ces équation comme sur la procédure \pageref{procedure_matlab} et vérifier que les résultats correspondent.}

~\

L'objectif est d'obtenir le profil suivant pour la vitesse de rotation \omegaentree.

\begin{center}
\graphicspath{{img/}}
\def\svgwidth{.7\columnwidth}
\input{"img/profil.pdf_tex"}
\end{center}

Données: $t_1=2s$, $t_2=8s$, $t_3=10s$. 
\questioncomp{mod}{Déterminer $\omega_{max}$ afin d'obtenir la variation de \angleentree\ de \deltaangleentree.}

\questioncomp{mod}{A l'aide d'un script python, déterminer le profil de vitesse à imposer à \omegamoteur.}
