...
\begin{itemize}
 \item De modéliser un asservissement,
 \item De mettre en équation le comportement d'un système asservis.
\end{itemize}
\end{prob}
}}

{\frame{
\frametitle{L'origine des systèmes asservis}

\textbf{Le régulateur de Watt}
...
\begin{minipage}{0.3\linewidth}
 \includegraphics[width=0.9\linewidth]{img/watt}
\end{minipage}

~\

\begin{minipage}{0.3\linewidth}
 \includegraphics[width=0.8\linewidth]{img/watt2}
\end{minipage}\hfill
\begin{minipage}{0.65\linewidth}
...
C'est un exemple de \textbf{Système Linéaire Continu et Invariant (S.L.C.I.)}.
\end{minipage}
}}
...
\begin{itemize}
 \item Additivité: si $x_1(t)$ a pour sortie $y_1(t)$ et $x_2(t)$ a pour sortie $_y2(t)$ alors $x_1(t) + x_2(t)$ a pour sortie $y_1(t) + y_2(t)$.
...
\begin{itemize}
 \item Non linéarités (seuil, saturation, hystérésis): 
  \raisebox{-3mm}{\includegraphics[width=0.4\linewidth]{img/non_lineaire}}
...
\begin{itemize}
 ...
 \item $s^{(i)}$ est la dérivée j\textsuperscript{ème} de la fonction  par rapport à une variable réelle temps $t$,
...
\includegraphics[width=0.8\linewidth]{img/dirac}
\end{minipage}
...
\end{minipage}\hfill
\begin{minipage}{0.35\linewidth}
\includegraphics[width=0.8\linewidth]{img/echelon}
\end{minipage}
}}
...
\begin{minipage}{0.6\linewidth}
\textbf{Fonction rampe}

Définie par $f(t)=t.u(t)$, $L[t.u(t)]=\int_{0}^{+\infty}t.e^{-pt}.dt$

Transformation de Laplace (Intégration par parties): \\ 
\begin{flushleft}
$L[t.u(t)]=\left[-t.\dfrac{1}{p}.e^{-pt}\right]_0^{+\infty}-\int_0^{\infty}-\dfrac{1}{p}.e^{-pt}.dt=0-\left[\dfrac{1}{p^2}.e^{-pt}\right]_0^{+\infty}$
\end{flushleft}
...
\end{minipage}\hfill
\begin{minipage}{0.35\linewidth}
\includegraphics[width=0.8\linewidth]{img/rampe}
\end{minipage}

\vfill

\begin{minipage}{0.6\linewidth}
\textbf{Fonction décroissance exponentielle}

$f(t)=e^{-at}.u(t)$

Transformation de Laplace : \\
\begin{flushleft}
$L[e^{-at}.u(t)]=\int_{0}^{+\infty}e^{-pt}.e^{-at}.dt=\int_{0}^{+\infty}e^{-(p+a)t}.dt=-\dfrac{1}{p+a}\left[-e^{-(p+a).t}\right]_0^{+\infty}$
\end{flushleft}
...
\end{minipage}\hfill
\begin{minipage}{0.35\linewidth}
\includegraphics[width=0.8\linewidth]{img/expo}
\end{minipage}
}}
...
\begin{rem}
\begin{itemize}
 \item Si $\xi > 1$, $\searrow$ $\xi \Rightarrow$ (à pulsation propre $\omega_0$ constante) $\nearrow$ rapidité du système, $\searrow$ $t_R$,
 \item Si $\xi < 1$, $\searrow$ $\xi \Rightarrow$ (apparition de pseudo-oscillations) $\searrow$ rapidité du système, $\nearrow$ $t_R$,
\end{itemize}
\end{rem}
...
\begin{itemize}
 \item \textit{Problème: Comment représenter la structure d'un asservissement ?}
