...
\prob{Préparer une présentation présentant les étapes suivantes:
\begin{enumerate}
 \item Présentation du système,
 \item Classes d'équivalence (Diagramme de Bloc),
 \item Liaisons (Captures d'écran SolidWorks pour justifier les surfaces en contact),
 \item Graphe de liaison,
 \item Schéma cinématique (avec les liaisons seules),
 \item Schéma cinématique paramétré,
 \item Équations entre les paramètres géométriques,
 \item Torseurs des liaisons.
\end{enumerate}} 
