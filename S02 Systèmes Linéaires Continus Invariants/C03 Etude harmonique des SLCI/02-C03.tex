...
\begin{minipage}{0.3\linewidth}
	\begin{itemize}
	 \item Le module $G_{db}=\vert H(j\omega) \vert$ est exprimé en décibel. 
	 \item La phase $\varphi$ est exprimée en degrés. 
	\end{itemize}
\end{minipage}
\hfill
\begin{minipage}{0.66\linewidth}
	\includegraphics[width=.9\linewidth]{img/Bode1}
\end{minipage}
}}
...
\begin{center}
	\includegraphics[width=0.7\linewidth]{img/Bode2}
\end{center}
}}
...
\begin{center}
	\includegraphics[width=0.6\linewidth]{img/Bode3}
\end{center}
}}
...
\frametitle{Cas du second ordre (z>1)}
\begin{center}
	\includegraphics[width=0.8\linewidth]{img/Bode5}
\end{center}
}}
...
\frametitle{Cas du second ordre (z=1)}
\begin{center}
	\includegraphics[width=0.8\linewidth]{img/Bode6}
\end{center}
}}
...
\frametitle{Cas du second ordre (z<1)}
\begin{center}
	\includegraphics[width=0.8\linewidth]{img/Bode7}
\end{center}
}}
