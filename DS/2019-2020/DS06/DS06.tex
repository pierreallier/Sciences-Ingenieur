...
\question{Expliciter la spécification \includegraphics[width=2cm]{img/specif_5} sur une page libre ou sur un tableau GPS.}

\question{Expliciter la spécification \includegraphics[width=2cm]{img/specif_1} sur une page libre ou sur un tableau GPS.}

\question{Expliciter la spécification \includegraphics[width=2cm]{img/specif_2} sur une page libre ou sur un tableau GPS.}

\question{Expliciter la spécification \includegraphics[width=2cm]{img/specif_3} sur une page libre ou sur un tableau GPS.}

\question{Expliciter la spécification \includegraphics[width=2cm]{img/specif_4} sur une page libre ou sur un tableau GPS.}
...
$-e.sin\theta+(R+r).cos\theta=0$, donc $\alpha=arcsin(\frac{e.sin\theta}{R+r})$
 ...
 $\overrightarrow{V_{I\in C/0}}=\overrightarrow{V_{I\in C/G}}+\overrightarrow{V_{I\in G/0}}$
 
 $\overrightarrow{V_{O'\in G/0}}=\overrightarrow{V_{I\in G/0}}+\overrightarrow{O'I}\wedge\overrightarrow{V_{I\in G/0}}$

 $\overrightarrow{O'I}\wedge\overrightarrow{V_{I\in G/0}}=-r.\overrightarrow{X_i}\wedge\omega_G.\overrightarrow{z}$

 $\overrightarrow{O'I}\wedge\overrightarrow{V_{I\in G/0}}=-r.(cos\alpha\overrightarrow{X}+sin\alpha\overrightarrow{Y})\wedge\omega_G.\overrightarrow{z}$

 $\overrightarrow{O'I}\wedge\overrightarrow{V_{I\in G/0}}=-r.\omega_G.(-cos\alpha\overrightarrow{Y}+sin\alpha\overrightarrow{X})$

 $\overrightarrow{V_{O'\in G/0}}.\overrightarrow{X}=0$
 
 $\omega_G=\frac{(R.sin\alpha-e.son\theta).\dot{\theta}}{r.sin\alpha}$
 
 $\overrightarrow{V_{O'\in G/0}}=(R.cos\alpha-e.cos\theta+r.cos\alpha.\omega_G).\overrightarrow{Y}=V_Y.\overrightarrow{Y}$
 
 $\left\{V_{G/0}\right\}=\left\{\begin{array}{cc}
 0 & 0 \\ 0 & V_Y \\ \omega_G & 0 \end{array}_{O'}\right\}$
\end{enumerate}
...
\ifdef{\public}{\includepdf[angle=90,offset=-0.5cm -0.5cm]{img/Calque.pdf}}
