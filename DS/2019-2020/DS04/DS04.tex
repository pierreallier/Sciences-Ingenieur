...
\question{Déterminer à quel tracé correspond la fonction de transfert de la question 16 et déterminer la valeur de l'échelon qui lui a été appliqué en entrée.}
...
\question{Proposer une solution d'assemblage par vis du système suivant. Une des deux pièces doit être taraudée, il n'est pas permis d'utiliser d'écrou. Représenter la réponse sur la vue en coup du document réponse \og Mécanisme de HOEKEN \fg.}
...
\reponse{10}{}{$L_2=\sqrt{(L_0+L_1.cos(\theta_1)-L_2.cos(\theta_3))^2+L_1.sin(\theta_1)-L_2.sin(\theta_3))^2}$.}

\reponse{8}{}{$\overrightarrow{AE}=L_0.\overrightarrow{x_0}+L_1.\overrightarrow{x_1}-2.L_2.\overrightarrow{x_3}=\left(\begin{array}{c} L_0+L_1.cos(\theta_1)-2.L_2.cos(\theta_3) \\ L_1.sin(\theta_1)-2.L_2.sin(\theta_3) \\ 0
\end{array}\right)$}
...
Ainsi, $Y_{13}=sin\theta_2.X_{31}-cos\theta_2.Y_{31}$ et $N_{Op3}=-F.sin\theta_2$.
