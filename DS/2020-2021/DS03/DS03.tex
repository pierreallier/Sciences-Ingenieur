...
\frac{1}{1+\frac{1}{M_{eq}\cdot p}\cdot K_c\cdot K_{verin}}\cdot \left(-F_{sol}\cdot k_{p\ MAX}\right)$
...
$H_2(p)=\frac{1}{1+\frac{1}{M_{eq}\cdot p}\cdot K_c\cdot K_{verin}}=\frac{\frac{M_{eq}}{K_c\cdot K_{verin}}\cdot p}{1+\frac{M_{eq}}{K_c\cdot K_{verin}}\cdot p}$
}
