...
\reponse{6}{}{
Pour $\omega>100rad.s^{-1}$, on peut l'assymiler à un premier ordre de fonction de transfert $H_r(p)=\frac{2.2\cdot p}{1+0.004\; p}$

$C_{obs}(p)=p\cdot\frac{0.6\cdot \epsilon(p)+10\cdot C_{r0}\cdot\tau}{246}\cdot\frac{2.2}{1+1.34\cdot p}$
}
