...
\includepdf[scale=0.95,offset=10 -30]{img/Piece/Piece5.pdf}
...
\includepdf[scale=0.95,offset=10 -30]{img/Piece/Piece5_couleur.pdf}

\paragraph{Question 3:}

\includepdf[scale=0.95,offset=10 -30]{img/Piece/Piece5_defauts.pdf}

\paragraph{Question 4:}

\includepdf[scale=0.95,offset=10 -30]{img/Piece/Piece5_specifs.pdf}
