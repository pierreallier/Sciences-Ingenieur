...
\hfill
\begin{minipage}{.3\linewidth}
 \centering\includegraphics[width=0.8\linewidth]{img/diode}
\end{minipage}
\hfill
\begin{minipage}{.3\linewidth}
\centering\begin{tikzpicture}
...
\hfill
\begin{minipage}{.3\linewidth}
 \centering\includegraphics[width=0.8\linewidth]{img/thyristor}
\end{minipage}
\hfill
\begin{minipage}{.3\linewidth}
\centering\begin{tikzpicture}
...
\hfill
\begin{minipage}{.3\linewidth}
 \centering\includegraphics[width=0.8\linewidth]{img/igbt}
\end{minipage}
\hfill
\begin{minipage}{.3\linewidth}
\centering\begin{tikzpicture}
...
\frametitle{Source de courant R,L}
 ...
 \centering\includegraphics[width=0.4\linewidth]{img/Simu_s01}
 
\begin{minipage}{0.49\linewidth}
 \centering\includegraphics[width=0.9\linewidth]{img/Simu01} \\
 Fréquence de commutation de 100Hz
\end{minipage}\hfill
\begin{minipage}{0.49\linewidth}
 \centering\includegraphics[width=0.9\linewidth]{img/Simu02} \\
...
\frametitle{Application: Alimentation d'un MCC}
 ...
 \centering\includegraphics[width=0.6\linewidth]{img/Simu_s025}
 
\begin{minipage}{0.49\linewidth}
 \centering\includegraphics[width=0.9\linewidth]{img/Simu03} \\
 Fréquence de commutation de 100Hz
\end{minipage}\hfill
\begin{minipage}{0.49\linewidth}
 \centering\includegraphics[width=0.9\linewidth]{img/Simu04} \\
...
\end{minipage}\hfill
\begin{minipage}{0.45\linewidth}
\centering\includegraphics[width=0.9\linewidth]{img/Simu05}
\end{minipage}
...
\vspace{-7mm}
\centering \includegraphics[width=\linewidth]{img/Simu_s0252}
\end{wrapfigure}
...
\begin{minipage}{0.55\linewidth}
 \centering\includegraphics[width=0.9\linewidth]{img/Simu_s03}
\end{minipage}\hfill
...
\end{minipage}\hfill
\begin{minipage}{0.48\linewidth}
 \centering\includegraphics[width=0.9\linewidth]{img/Simu06}
\end{minipage}
}}
...
\vspace{-7mm}
\centering \includegraphics[width=\linewidth]{img/brushless}
\end{wrapfigure}
