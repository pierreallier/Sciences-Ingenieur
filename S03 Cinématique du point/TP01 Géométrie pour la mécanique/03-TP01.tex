...
\question{Projeter cette relation dans la base $B_0(\overrightarrow{x_0},\overrightarrow{y_0},\overrightarrow{z_0})$ afin d'obtenir deux équations scalaires. On fera apparaître \resultatscalaire}

\question{A partir de ces équations, déterminer la relation \relation.}

\section{Vérification par la simulation}

\question{Simuler le modèle Simulink (version 2016a) sans le modifier, vérifier les données affichées.}
...
\question{Filmer le mouvement \dusysteme dans la même vue que celle du schéma cinématique.}
