...
\section{Activité 3: Comportement du MobyCrea}

En utilisant le logiciel de pilotage du MobyCrea \og Asservissement horizontal\fg, faire varier la vitesse du mouvement. On considère que la position axiale du MobyCrea est pilotée par une consigne $x_e(t)=E_0.sin(\omega_e.t)$ et que cela génère un déplacement $x(t)=S_0.sin(\omega_s.t+\Phi)$.

\paragraph{Question 10:} En effectuant plusieurs mesures, déterminer graphiquement les valeurs de $\omega_e$, $\omega_s$, $E_0$, $S_0$ et $\phi$.

\paragraph{Question 11:} Expliquer pourquoi physique sur ce système, la relation $E_0=S_0$ est toujours vraie.

\paragraph{Question 12:} Dans ce cas là, que se passe-t-il lorsque le système \og décroche \fg. 
